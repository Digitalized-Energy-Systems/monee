...
````{only} html
```{raw} html
<iframe src="../_static/interactive/benchmark_pandapower.html" width="100%" height="1080" style="border:none;" loading="lazy" title="monee vs pandapower: solve time, bus-voltage agreement, and slack-power agreement for AC power flow and OPF"></iframe>
```
````
...
````{only} html
```{raw} html
<iframe src="../_static/interactive/benchmark_pandapipes.html" width="100%" height="1800" style="border:none;" loading="lazy" title="monee vs pandapipes: solve time, pressure agreement, and temperature agreement for gas, heat, and coupled MES flow"></iframe>
```
````
